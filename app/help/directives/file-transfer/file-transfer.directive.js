(function() {
    ...
    function FileTransfer() {
         ...
         */
        function FileTransferController($window) {
            var vm = this;
            ...
            function connect(c) {
                ...
                if (c.label === 'chat') {
                    ...
                    c.on('close', function() {
                        $window.alert(c.peer + ' has left the chat.');
                        chatbox.remove();
        ...
        var directive = {
            ...
            templateUrl: 'help/directives/file-transfer/file-transfer.directive.html',
            link: _link,
    ...
    angular
        .module('help')
        .directive('fileTransfer', FileTransfer);
